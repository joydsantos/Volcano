...
tbl_remotestation_equip_category and tbl_remote_stationtype ay pinagpalit ng name sa html so ung na aaccess sa category ay station type

*/

// Start the session
$query = "SELECT * FROM tbl_remote_stationtype";
            ...
            <div id="content">
                ...
                <div class="container d-flex justify-content-center">
                    <ul class="pagination shadow-lg">
                        <li class="page-item active"> <a class="page-link" href="javascript:void(0);" onclick="hideshow('remoteCatSection');">

                                <small class="s">Remote Category</small>
                            </a>
                        </li>
                        <li class="page-item" id="unitMeasurementPage">
                            <a class="page-link" href="javascript:void(0);" onclick="hideshow('remoteStationType');">

                                <small class="s">Station</small>
                            </a>
                        </li>
                    </ul>
                </div>
                <div class="container mt-4 d-flex justify-content-center">
                    <div class=" card rounded-2 shadow-lg" style="background-color: white; width: 100%;padding-bottom: 3%; " id="remoteCatSection">
                        <div class="card-header " style="background-color: white;" id="remoteStationCat">
                            <div class="row mt-3 mx-auto text-center">
                                <div class="col-md-12">
                                    <h4 class="paragraph " style="color: black"> Remote Category</h4>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
